...
class AdminOfferDetailsPage extends StatefulWidget {
  final String offerId;
  final bool isActive; // To differentiate between active and inactive offers

  const AdminOfferDetailsPage({super.key, required this.offerId, this.isActive = true});

  @override
  State<AdminOfferDetailsPage> createState() => _AdminOfferDetailsPageState();
}

class _AdminOfferDetailsPageState extends State<AdminOfferDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //     },
      //   ),
      //   title: Text(widget.isActive ? 'Active Offer Details' : 'Inactive Offer Details'),
      //   backgroundColor: widget.isActive ? Colors.red : Colors.orange,
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(widget.isActive ? 'Active Offer Details' : 'Inactive Offer Details',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                    ],
                  ),
              ...
              Builder(builder: (_) {
                ...
                if (images.isEmpty) {
                  ...
                  return GestureDetector(
                    onTap: () => _showFullScreenImage(context, 'assets/img.png', title: 'Default Image'),
                    child: Container(
                      height: 300,
                    ...
                    children: [
                      ...
                      PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () => _showFullScreenImage(context, images[index], title: 'Offer Image'),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        if (controller.shopImageUrl.isNotEmpty)
                          GestureDetector(
                            onTap: () => _showFullScreenImage(context, controller.shopImageUrl, title: 'Shop Image'),
                            child: Container(
                              width: 50,
                              height: 50,
                              ...
                              clipBehavior: Clip.antiAlias,
                              child: Image.network(controller.shopImageUrl,
                              fit: BoxFit.cover,),
                            ),
                          )
                        else
                    ...
                    Builder(builder: (context) {
                      final String shopPhone = controller.shopInfo!['number'] ?? '';
                      ...
                      return InkWell(
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              children: [
                                const Icon(Icons.contact_phone, color: Colors.black54),
                                const SizedBox(width: 8),
                                Text(
                                  shopPhone,
                                  style: const TextStyle(
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        return InkWell(
                          onTap: () => _showWorkingHoursDialog(context, controller),
                          borderRadius: BorderRadius.circular(12),
                          child: Container(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        controller.isShopOpen ? 'Open Now' : 'Closed',
                                        style: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.w500,
              ...
              // Share Button (No Add to Cart/Favorite for admin)
              if(widget.isActive)
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Column(
                    children: [
                      const Text("Share Offer", style: TextStyle(fontSize: 12, color: Colors.grey)),
                      const SizedBox(height: 8),
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset("assets/whatsapp.png", height: 28, width: 28),
                        ),
                      ),
                    ],
                  ),
  ...
  void _showWorkingHoursDialog(BuildContext context, OfferDetailsController controller) {
    final workingHours = controller.formattedWorkingHours;
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
                  decoration: BoxDecoration(
                    color: controller.isShopOpen ? Colors.green[50] : Colors.red[50],
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: controller.isShopOpen ? Colors.green[300]! : Colors.red[300]!,
                      width: 1.5,
                    ),
                  ),
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: controller.isShopOpen ? Colors.green[100] : Colors.red[100],
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Icon(
                          controller.isShopOpen ? Icons.check_circle : Icons.cancel,
                          color: controller.isShopOpen ? Colors.green[600] : Colors.red[600],
                          size: 16,
                        ),
                      ),
                      const SizedBox(width: 8),
                      Text(
                        controller.isShopOpen ? 'Currently Open' : 'Currently Closed',
                        style: TextStyle(
                          color: controller.isShopOpen ? Colors.green[700] : Colors.red[700],
                          fontWeight: FontWeight.w600,
                          fontSize: 14,
                        ),
                      ),
  ...
  void _showFullScreenImage(BuildContext context, String imageUrl, {String title = 'Image Viewer'}) {
    Navigator.push(
      context,
      MaterialPageRoute(
