...
import 'package:eastnshop/Screen/Login/ForgotPasswordOtpVerification.dart';
import 'package:eastnshop/Screen/Login/TermsAndConditions.dart';
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  InkWell(
                    onTap:
                        (emailController.text.length == 10 && !isLoading)
                            ? _sendOtp
                            : null,
                    child: Container(
                      height: 50,
