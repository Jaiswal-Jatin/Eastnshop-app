...
class _SignupState extends State<Signup> {
  ...
  bool _isCheckingPhone =
      false; // Track if phone existence check is in progress
  bool _isPhoneAlreadyRegistered = false; // Track if phone is already in use
  Timer? _phoneCheckDebounce;
  String _successMessage = ''; // Track success message display
  ...
  void _clearForm() {
    setState(() {
      ...
      loginController.userrole.text = "user"; // Always set to shopkeeper
      isChecked = false;
  ...
  Future<void> _checkPhoneAlreadyExists(String value) async {
    _phoneCheckDebounce?.cancel();
    ...
    _phoneCheckDebounce = Timer(const Duration(milliseconds: 450), () async {
      if (!mounted) return;
      ...
      final result = await loginController.checkPhoneAlreadyExists(value);
      if (!mounted) return;
      ...
      setState(() {
        _isCheckingPhone = false;
        _isPhoneAlreadyRegistered = result['exists'] == true && !isDifferentRole;
                                ...
                                SizedBox(
                                  ...
                                  child: TextField(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      _checkPhoneAlreadyExists(value);
                                    },
                                    decoration: InputDecoration(
                                      ...
                                      focusedBorder: OutlineInputBorder(
                                        ...
                                        borderSide: const BorderSide(
                                          color:
                                              Colors
                                                  .black38, // slightly darker grey when focused
                                          width: 1.2,
                                        ),
                                      ),
                                    ...
                                    (loginController
                                        ...
                                        ? () async {
                                          ...
                                          if (result['success']) {
                                            setState(() {
                                              _isOtpSent = true;
                                              _seconds = 60; // Reset timer to 60 seconds
                                              _errorMessage = '';
                                              _successMessage =
                                                  result['message'] ??
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: const TextStyle(
                                          ...
                                          fontSize: 14,
                                          color:
                                              AppColors.secondaryBlue, // #2C8DFE
                                        ),
                                      ),
                                    ],
                                  ),
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                // Check if OTP is already verified, if not verify it
                                if (_isPhoneAlreadyRegistered) {
                                  setState(() {
                                    _errorMessage =
                                        "Phone number already exists. Please login instead.";
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: _isCreatingAccount ? Colors.grey : Color(0xFFFF9900),
                                ),
                                child: Center(
